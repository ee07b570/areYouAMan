...
import { PLAYER_GROUD_BOTTOM, INIT_MISSILE_SPEED, INIT_POSITION_SEED, MISSILE_WIDTH, MISSILE_HEIGHT } from '../config'
...
function randInitPosition() {
  return Math.floor(INIT_POSITION_SEED * Math.random())
}
